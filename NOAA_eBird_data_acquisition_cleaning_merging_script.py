...
all_data_df['observationTime'] =  pd.to_datetime(all_data_df['observationTime'], format='%H:%M:%S').dt.time
all_data_df['highhighTime'] =  pd.to_datetime(all_data_df['highhighTime'], format='%H:%M:%S').dt.time
all_data_df['highTime'] =  pd.to_datetime(all_data_df['highTime'], format='%H:%M:%S').dt.time
all_data_df['lowTime'] =  pd.to_datetime(all_data_df['lowTime'], format='%H:%M:%S').dt.time
all_data_df['lowlowTime'] =  pd.to_datetime(all_data_df['lowlowTime'], format='%H:%M:%S').dt.time
all_data_df.head()
